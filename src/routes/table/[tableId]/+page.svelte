			...
			>
				<div class="flex flex-col p-6 lg:flex-1">
					...
					>
						...
						{:else}
							<div
								class="flex flex-col items-center p-8 text-center text-gray-500 dark:text-gray-400"
							>
								<div class="mb-4 text-6xl">🏢</div>
					...
					<div class="flex-shrink-0 space-y-4">
						...
						{#if progressValue > 50}
							<div
								class="rounded-lg border border-gray-300 bg-white dark:border-gray-600 dark:bg-gray-900"
							>
								<button
									type="button"
									...
									<div class="border-t border-gray-200 p-4 dark:border-gray-600">
										<div class="space-y-3">
											...
											<div class="rounded-lg bg-gray-50 p-3 dark:bg-gray-800">
												<pre
													class="max-h-40 overflow-y-auto text-xs whitespace-pre-wrap text-gray-700 dark:text-gray-300">{buildPromptFromConfig(
														true
													)}</pre>
											</div>

											<p class="text-xs text-gray-500 dark:text-gray-400">
												This prompt includes your persona details and all form inputs (with
												placeholders for empty fields) that will guide the AI generation.
											</p>
										</div>
									</div>
								{/if}
