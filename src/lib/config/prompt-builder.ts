...
export const SCENE_SETTING = `Design an office which is relevant in 2033. Photorealistic architectural visualization of a complete future-forward workspace ecosystem. Capture the entire spatial narrative from an elevated three-quarter perspective showing: multiple interconnected zones and their relationships, natural flow between collaborative, focused, and social areas, architectural elements that define the workspace character, strategic sightlines and circulation paths, environmental context through windows/skylights. The design should embody forward-thinking 2033 workspace philosophy tailored to the specific persona's generational values, location context, and professional requirements.`;
